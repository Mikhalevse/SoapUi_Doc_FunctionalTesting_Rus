...
/* Properties are a central aspect of more advanced testing with soapUI (a general overview of property-management is available at ..). */ Свойства - важная составляющая более продвинутого тестирования с помощью soapUI (общий обзор управления свойствами доступен по ..). 
<!-- 
