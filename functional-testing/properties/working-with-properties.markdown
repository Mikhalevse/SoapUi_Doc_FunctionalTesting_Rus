...
Свойства - важная составляющая более продвинутого тестирования с помощью soapUI (общий обзор управления свойствами доступен по ..).<!-- In regard to Functional Testing properties are used to parameterize the execution and functionality of your tests, for example: -->В части функционального тестирования свойства используются для параметризации исполняемых тестов, например:
